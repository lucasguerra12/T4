        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6 text-center">
            ...
            <div className="max-w-3xl w-full bg-white p-10 rounded-xl shadow-lg transform transition-all hover:scale-105 duration-300">
                ...
                <div className="mt-10 flex justify-center gap-x-6">
                    <a
                        href="/clientes"
                        className="px-8 py-3 bg-purple-600 text-white font-semibold rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-75 transition-transform transform hover:scale-110 duration-300"
                    >
                        Gerenciar Clientes
                    </a>
                    <a
